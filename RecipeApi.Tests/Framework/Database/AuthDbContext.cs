...
{   
    ...
    public IEnumerable<IDatabaseReadable<User>> GetEntities(string query) where TEntity : IDatabaseReadable<User>, new()
    {
        return (IEnumerable<IDatabaseReadable<User>>)Users;
    }

    public Task<IEnumerable<User>> GetEntitiesAsync<TEntity>(string query) where TEntity : IDatabaseReadable<User>, new()
    {
